...
WITHDRAW_COMMAND_NAME = "/bank_snyat"
...
RULES_TEXT = (
    ...
    "<b>Команды:</b>\n"
    "/bank — эти правила и текущий остаток (потом можно сразу написать сумму)\n"
    "/bank положить СУММА (или «всё») — внести на вклад сразу\n"
    f"{WITHDRAW_COMMAND_NAME} — снять деньги со вклада (отдельная команда)"
)
