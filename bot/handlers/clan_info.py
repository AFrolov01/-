...
START_TEXT = (
    ...
    "Дуэли между кланами бот объявляет сам, примерно раз в день. Сезон войны "
    "длится 30 дней, по истечении которых бот сам подведёт итоги и объявит "
    "победителя, после чего начнётся новый сезон.\n"
